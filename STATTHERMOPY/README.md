...
**Qt GUI — Properties tab** (pure-gas / mixture editor, state inputs, results and
per-mode breakdown; light/dark theming):

![StatThermoPy GUI — Properties tab](props_tab.png)

**Property-vs-temperature plots** (generated by the engine; molar heat capacity
of N₂ shown):
